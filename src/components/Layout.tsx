...
export default function Layout({ children, currentPageName }: LayoutProps) {
  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen w-full bg-gradient-to-br from-slate-50 to-emerald-50 relative overflow-hidden">
        <style>
          {`
            :root {
              --golf-primary: #1e3a2e;
        ...
        {/* --- Desktop Sidebar --- */}
        <div className="hidden md:flex fixed left-0 top-0 h-full w-64 border-r border-emerald-100/50 bg-white/90 backdrop-blur-md shadow-lg z-40">
        ...
        {/* --- Main Content Area --- */}
        <main className="flex-1 flex flex-col pb-20 md:pb-0 md:ml-64 relative z-10 min-h-screen">
